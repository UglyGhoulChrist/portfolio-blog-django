...
class ExtUser(models.Model):
    ...
    pictureExtUser = models.FileField(verbose_name='Картинка на первом экране', upload_to='JohnWebSite/img', null=True, blank=True)
...
class Social(models.Model):
    ...
    pictureSocial = models.FileField(verbose_name='Картинка социальной сети', upload_to='JohnWebSite/img', null=True, blank=True)
...
class Project(models.Model):
    ...
    def __str__(self):
        return f'{self.title} {self.linkProject}'
